...
const clearButton = documento.querySelector('.app-pwd__button--clear'); //Botão para limpar o histórico de senhas
...
const datetimeElement = document.querySelector('.app-pwd__datatime') // Elemento de data e hora
